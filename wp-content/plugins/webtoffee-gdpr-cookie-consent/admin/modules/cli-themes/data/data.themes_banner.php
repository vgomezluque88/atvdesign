...
(
	...
	'config'=>array(
		...
		"button_1"=>array(
			"status"=>1,
			"text"=>"Accept",
			"style"=>"margin: 5px 5px 5px 30px; border-radius: 0px; padding: 8px 25px; color:#ffffff; background-color:#61a229; border-color: #61a229;"
		),
		"button_2"=>array(
			"status"=>1,
			"text"=>"Read more",
		...
		"button_3"=>array(
			"status"=>1,
			"text"=>"Reject",
			"style"=>"margin: 5px 5px 5px 10px; border-radius: 0px; padding: 8px 25px; color:#ffffff; background-color:#61a229; border-color: #61a229;"
		),
		"button_4"=>array(
			"status"=>1,
			"text"=>"Cookie settings",
			"style"=>"border:none; padding:0px; border-bottom: 1px solid; color: rgb(137, 136, 136);text-decoration: none;"
		),
		"button_5"=>array(
			"status"=>1,
			"text"=>"X",
...
(
	...
	'config'=>array(
		...
		"button_7"=>array(
			"status"=>1,
			"text"=>"Accept All",
			"style"=>"margin: 5px 5px 5px 5px; border-radius: 0px; padding: 8px 25px; color:#ffffff; background-color:#61a229; border-color: #61a229;"
		),
	)
);
