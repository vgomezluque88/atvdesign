...
(
	...
	'config'=>array(
		...
		"button_1"=>array(
			"status"=>1,
			"text"=>"Accept",
			"style"=>"margin: 5px; border-radius: 0px; padding: 8px 25px; color:#ffffff; background-color:#61a229; border-color: #61a229;"
		),
		"button_2"=>array(
			"status"=>1,
			"text"=>"Read More",
...
(
	...
	'config'=>array(
		...
		"button_4"=>array(
			...
			"style"=>"border:none; padding:0px; border-bottom: 1px solid; text-decoration: none; color: rgb(137, 136, 136);"
		),
		"button_5"=>array(
			"status"=>1,
			"text"=>"X",
...
(
	...
	'config'=>array(
		...
		"button_1"=>array(
			"status"=>1,
			"text"=>"Accept",
			"style"=>"margin: 5px; border-radius: 0px; padding: 8px 25px; color: rgb(255, 255, 255); background-color: rgb(97, 162, 41); border-color: #61a229;"
		),
		"button_2"=>array(
			"status"=>1,
			"text"=>"Read more",
