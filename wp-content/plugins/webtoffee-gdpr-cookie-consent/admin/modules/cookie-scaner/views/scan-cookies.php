...
.wt-cli-scan-result-actions .wt-cli-cookie-scan-btn {
    color: #0071a1;
    border-color: #0071a1;
    background: #f3f5f6;
}
...
.wt-cli-scan-result-actions > a {
	margin-left:15px !important;
}
</style>
<div class="wrap">
	<h2><?php _e( 'Cookie scanner', 'webtoffee-gdpr-cookie-consent' );  // phpcs:ignore WordPress.Security.EscapeOutput ?></h2> 
