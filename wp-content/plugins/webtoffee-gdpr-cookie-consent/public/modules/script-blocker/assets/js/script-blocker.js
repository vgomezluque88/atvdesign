(function ($) {
    ...
    var CLIScriptBlocker = {
        ...
        changeCategoryEvent: function () {
            jQuery('[name="cliscript_category"]').on('change', function (e) {
                e.preventDefault();
                CLIScriptBlocker.changeCategory(jQuery(this));
            });
        },
        disableEvents: function () {
            ...
            jQuery('.wt-cli-plugin-inactive').find('select[name="cliscript_category"]').prop('disabled', true);
        },
        ...
        changeCategory: function () {
            jQuery('[name="cliscript_category"]').on('change', function (e) {
                ...
                var script_id = element.closest('tr').attr('data-script_id');
